...
def get_logger(name: str) -> logging.Logger:
    """
    Function: get_logger
    Purpose: Gives every module a consistant logging style, and makes them go to the same place
...
#Reads and loads a YAML reference congfiguration file and returns it as a Python directionary
